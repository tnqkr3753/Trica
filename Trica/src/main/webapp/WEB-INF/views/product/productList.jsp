...
<body>
	...
	<div class="breadcrumb-area set-bg"
	 ...
	 <div class="container" style="width: 80%; margin-left:300px;">
      <div class="row-fluid">
         <!--span-->
         <div class="span9" id="content" style="width:1500px;">
            <div class="row-fluid">
               <br />
                  ...
                  <table class="table">
                     ...
                     <c:forEach items="${list}" var="list">
                        <tr>
                           ...
                           <td style="width:150px;"><form action="goModify.trc" method="post">
                                 <input type="hidden" name="pctNo" value="${list.pctNo}">
                              </form>${list.pctNo}</td>
                           <td style="width:150px;"><input type="hidden" name="pctStock"
                              value="${list.pctStock}">${list.pctStock}</td>
                           <td><input type="hidden" name="pctName"
                              value="${list.pctName}">${list.pctName}</td>
                           <td style="width:150px;"><input type="hidden" name="pctPrice"
                           ...
                           <td style="width:200px;"><input type="hidden" name="pctRegDate"
