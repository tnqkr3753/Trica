				...
				<div class="row">
					...
					<c:forEach var='list' items="${sList }">
						<div class="col-lg-4 col-md-6 product-item">
							<form name='next_go' id='next_go' action="productDetail.trc"
								method="get">
...
<%-- 											${list.PCT_NAME }</div> --%>
										...
										<c:choose>
											<c:when test="${list.PCT_STOCK<= 15 and list.PCT_STOCK ne 0}">
												<!-- 마감임박 -->
												<span><img src="./resources/img/soldout.gif"
													height='50' width='50'></span>
											</c:when>
											<c:when test="${list.PCT_STOCK == 0}">
												<span><img src="./resources/img/soldout2.png"
...
<!-- 													<span class="icon_star"></span> -->
											...
											<ul>
												<li><span class="icon_pencil"></span>${list.PCT_INTRO }</li>
												<!-- 짧은 설명 -->
											</ul>
										</div>
									</div>
