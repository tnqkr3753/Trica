					...
					<div class="header__nav">
						<nav class="header__menu mobile-menu">
							<ul>
								...
								<c:if test="${1 eq sessionScope.memberType}">
									<!-- 관리자일 때  value='1' -->
									<li><a href="#">User</a>
										<ul class="dropdown">
									...
									<li><a href="#">management</a>
										<ul class="dropdown">
											...
											<li><a href="chart.trc">Statistics management</a></li>
										</ul></li> 
								</c:if>
								<c:if
									test="${!empty sessionScope.memberId and 0 eq sessionScope.memberType}">
									<!-- 구매자일 때  value='0' -->
									<li><a href="#">User</a>
										<ul class="dropdown">
											<li><a href="goChk.trc">Information</a></li>
						...
						<div class="header__menu__right">
							<c:choose>
								<c:when test="${empty sessionScope.memberId}">
									<a href="LoginPage.trc" class="login-btn"><i
										class="fa fa-user"></i></a>
								</c:when>
								<c:when test="${1 eq sessionScope.memberType}">
									<li><a href="productInsert.trc" class="primary-btn"><i
											class="fa fa-plus"></i>Add Listing</a></li>
								</c:when>
							</c:choose>
						</div>
					</div>
